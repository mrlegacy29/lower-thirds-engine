...
const suites = ['final_check2','exclude_test2','sweep','evtest4',
                ...
                'source_fallback_test','sdi_test','relay_security_test','graphics_io_test','clock_test','theme_rules_test','qr_test','qr_smoke_test','take_status_test','preset_resilience_test','console_controls_test','databind_test','audit_fixes_test','pp_label_ui_test','logo_layer_test','clear_screen_test','copy_look_test','local_media_test','big_look_test'];
